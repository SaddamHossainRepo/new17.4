        ...
        <div className="flex justify-between ">
          <div className="aboutLeftParent">
            ...
            <p className="cardBaseText AboutCardTopBottom">
              ...
              , where Creativity Meets Digital Excellence. We're more than just
              a service provider; we're dedicated to crafting experiences that
              make a lasting impact. With a foundation built on a passion for
              storytelling and a drive for innovation, our team is committed to
              elevating your digital presence. Specializing in branding, web
              design, videography, marketing, and communications, we excel in
              creating compelling narratives, captivating audiences, and driving
