...
const AboutUsPage = () => {
  ...
  return (
    <div>
      <div
        className=" bg-[url('/portFoliohero.png')] bg-no-repeat bg-top-center w-[100%] bg-black 
   2xl:h-[100dvh] 
   xl:h-[100dvh] 
   lg:h-[100dvh] 
   md:h-[100dvh] 
                ...
                <div className=" lg:text-justify xl:text-justify 2xl:text-justify ">
                  ...
                  <p
                    className="2xl:pb-[50px]  2xl:text-[30px] 2xl:leading-[51px] 2xl:pt-0
                                    xl:text-[25px] xl:leading-[38.75px] xl:text-justify
                                    lg:text-[25px] lg:leading-[30px] lg:text-justify
                                    md:text-[20px] md:leading-[25px] md:text-justify
