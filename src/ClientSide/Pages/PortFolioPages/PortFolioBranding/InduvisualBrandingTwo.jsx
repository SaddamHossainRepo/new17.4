            ...
            ">
                <div className="brandigParent">
                    ...
                    <div>
                        ...
                        <p className="singleBrandPara">Care Connect is a beacon of hope and support for those seeking customized healthcare and well-being solutions. At the heart of its philosophy lies a profound belief in the uniqueness of each individual and the importance of tailoring care to their specific needs and preferences.</p>
                        <p className="singleBrandPara">
                        The dedicated team at Care Connect understands that no two individuals are alike, and as such, their care should not be standardized. Whether it's assistance with daily activities, medical support, or nurturing emotional well-being, they are committed to crafting personalized care solutions that resonate with every phase of life.
                        </p>
                        <p className="singleBrandPara">
                        Central to their approach is a systematic methodology that ensures every aspect of care is centered around the individual patient. They prioritize patient-focused care, recognizing that true wellness stems from addressing not just symptoms, but the holistic needs of each person.
                        </p>
                    </div>
                    <div>
                        ...
                        <p className="forntLink">https://fonts.google.com/specimen/Poppins</p>
                    </div>
                    <div className="SingleBrandingImg">
                        <img className=" h-full w-full" src="/careconnect.png" alt="" />
                    </div>
                    <div>
                        <h3 className="titleSubHeading 2xl:pt-[200px] xl:pt-[180px] lg:pt-[150px] md:pt-[100px]
                        ...
                        <div className="grid grid-cols-2 2xl:gap-[50px] xl:gap-[40px] lg:gap-[30px] md:gap-[25px] gap-[20px] ">
                            ...
                            <div className=" 2xl:space-y-[50px] xl:space-y-[40px] lg:space-y-[30px] md:space-y-[25px] space-y-[25px] ">
                                <div className="projetImgOne">
                                    <img className="w-full  h-full 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Group328.png" alt="" />
                                </div>
                                ...
                                <div className="projetImgOne">
                                    <img className="w-full  h-full 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Group326.png" alt="" />
                                </div>
                            ...
                            <div className="2xl:space-y-[50px] xl:space-y-[40px] lg:space-y-[30px] md:space-y-[25px] space-y-[25px]  ">
                                <div className="projetImgTwo">
                                    <img className="w-full  h-full 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Group327.png" alt="" />
                                </div>
                                <div className="projetImgOne">
                                    <img className="w-full  h-full 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Rectangle64.png" alt="" />
                                </div>
                                {/* <div className="projetImgOne">
